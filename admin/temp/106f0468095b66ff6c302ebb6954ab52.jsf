<?php /*a:4:{s:59:"/www/wwwroot/jifei.ymcx.shop/view/admin/update/setunit.html";i:1606721957;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">插件设置</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">系统商店</a></li>
                                    <li class="breadcrumb-item active"><?php echo htmlentities($_GET['name']); ?>设置</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">代码设置</h4>
                                            <p class="card-title-desc">可在此页面修改<code>也可以在文件中修改！</code> </p>
                                            <input type="hidden" name="name" value="<?php echo htmlentities($_GET['name']); ?>">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">代码</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="cont"  rows="40"><?php echo htmlentities($cont); ?></textarea>
                                                </div>
                                            </div>
