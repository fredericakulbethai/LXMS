<?php /*a:4:{s:56:"/www/wwwroot/jifei.ymcx.shop/view/admin/order/index.html";i:1606639231;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">订单列表</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">订单列表</a></li>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">未支付订单需要定时清理删除<code>注意</code>.
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlentities($data['ordernum']); ?></td>
                                                    <td><?php echo htmlentities($data['username']); ?></td>
                                                    <td><?php if($data['method'] == '1'): ?>支付宝<?php endif; if($data['method'] == '3'): ?>微信<?php endif; ?></td>
                                                    <td><?php echo htmlentities($data['payment']); ?>元</td>
                                                    ...
                                                    <td><?php if($data['status'] == '1'): ?><span class="badge badge-success">已支付</span><?php endif; if($data['status'] == '0'): ?><span class="badge badge-danger">未支付</span><?php endif; ?></td>
                                                    <td><a href="<?php echo url('/admin/Order/deletejk?id='.$data['id'].''); ?>">删除</a></td>
                                                </tr>
