<?php /*a:4:{s:64:"/www/wwwroot/zc.appearoo.top/view/admin/site_manage/examine.html";i:1615049899;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1615047338;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">资源审核</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">资源审核</a></li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">通过后请在资源管理<code>查看</code>.
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlentities($data['xurl']); ?></td>
                                                    ...
                                                    <td><span class="badge badge-success">未审核</span></td>
                                                    <td><a href="" onclick="tg('./shenzy','<?php echo htmlentities($data['id']); ?>')">通过</a> <a href="" onclick="tg('./deletezy','<?php echo htmlentities($data['id']); ?>')">删除</a></td>
                                                </tr>
