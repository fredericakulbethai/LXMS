<?php /*a:4:{s:57:"/www/wwwroot/jifei.ymcx.shop/view/admin/update/index.html";i:1606722752;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">系统商店</h4>
                                    <ol class="breadcrumb m-0">
                                        
                                    <li class="breadcrumb-item active">当前token：<?php echo session('jifei'); ?></li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title font-size-16 mt-0">简约首页主题</h4>
                                            <p class="card-text">系统自带默认前台主题,可在此进行设置修改等,修改前请备份以免导致错改无法正常使用等！</p>
                                            <a href="./setunit?name=default" class="btn btn-primary waves-effect waves-light" style="">设置</a>
                                        </div>
                                    </div>
                                </div>
                              
                            </div>
                             <h1 style="text-align:center;">插件库</h1>
                           <div class="row">
