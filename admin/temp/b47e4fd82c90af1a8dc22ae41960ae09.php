<?php /*a:4:{s:61:"/www/wwwroot/jifei.ymcx.shop/view/admin/user_manage/edit.html";i:1606705990;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value='<?php echo htmlentities($row['username']); ?>' readonly="readonly" name="username" placeholder="例如 包月套餐">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">UID</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" value='<?php echo htmlentities($row['user_uid']); ?>' name="user_uid">
                                                </div> 
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value='<?php echo htmlentities($row['user_key']); ?>' name="user_key">
                                                </div> 
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="custom-select" id="dian" name="type">
                                                        <option value="1" <?php if($row['type'] == '1'): ?>selected<?php endif; ?>>包点用户</option>
                                                        <option value="2"<?php if($row['type'] == '2'): ?>selected<?php endif; ?>>包月用户</option>
                                                    </select>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row" id="k">
                                                <label for="example-url-input" class="col-md-2 col-form-label" id="textmonth"><?php if($row['type'] == '1'): ?>剩余点数<?php else: ?>到期时间<?php endif; ?></label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value='<?php echo htmlentities($row['surplus']); ?>' name="surplus">
                                                </div>
                                            </div>
                                            <div class="form-group row" id="limit">
                                            <?php if($row['type']==2): ?>
                                                <label for="example-url-input" class="col-md-2 col-form-label" id="textmonth">限制</label><div class="col-md-10"><input class="form-control" type="number"  name="limitnum" value="<?php echo htmlentities($row['limitnum']); ?>" placeholder="限制每日调用次数 例如10000"></div>
                                            <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value='<?php echo htmlentities($row['balance']); ?>' name="balance">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="custom-select" name="status">
                                                        ...
                                                        <option value="0"<?php if($row['status'] == '2'): ?>selected<?php endif; ?>>关闭</option>
                                                    </select>
                                                </div>
                                            </div>
