<?php /*a:4:{s:64:"/www/wwwroot/zc.appearoo.top/view/admin/globalsite/pay_site.html";i:1603849908;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1615047338;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">支付设置</h4>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">支付信息配置</h4>
                                            <p class="card-title-desc">码支付官网 <code>https://codepay.fateqq.com/home.htm</code> </p>
    
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">支付ID</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($zfid); ?>" name="zfid">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">密钥</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($zfkey); ?>" name="zfkey">
                                                </div> 
                                            </div>
        ...
        <script>
            $(document).ready(function(){
                $("#submit").click(function(){
                        ...
                        var zfid    = $("input[name='zfid']").val();
                        var zfkey = $("input[name='zfkey']").val();
                        $.ajax({
                          url:'/admin/globalsite/paySettings',
                          type:'post',
                          data:{
                              zfid:zfid,
                              zfkey:zfkey,
