<?php /*a:4:{s:55:"/www/wwwroot/zc.appearoo.top/view/admin/order/call.html";i:1606530188;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1615047338;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">调用记录</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">调用记录</a></li>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">调用记录</h4>
                                            <p class="card-title-desc">调用记录可定时清理删除<code>需在定时任务设置</code>.
                                           
                                            </p>
                                            
                                            <span class="badge badge-success">当前解析成功率为：<?php echo htmlentities($b); ?>%</span>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if($data['status'] == '1'): ?><span class="badge badge-success">成功</span><?php endif; if($data['status'] == '0'): ?><span class="badge badge-danger">失败</span><?php endif; ?></td>
                                                    <td><a href="<?php echo url('/admin/Order/deletejk2?id='.$data['id'].''); ?>">删除</a></td>
                                                </tr>
