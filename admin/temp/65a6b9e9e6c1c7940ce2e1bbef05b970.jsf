<?php /*a:4:{s:65:"/www/wwwroot/jifei.ymcx.shop/view/admin/resour_manage/serach.html";i:1603887175;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1603781536;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1603879294;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1603799604;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="#"><i class="mdi mdi-face-profile font-size-16 align-middle mr-1"></i> 账号设置</a>
                                <a class="dropdown-item" href="#"><i class="mdi mdi-credit-card-outline font-size-16 align-middle mr-1"></i> 系统订单</a>
    ...
    <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo url('/admin/ResourManage/serach'); ?>">资源查询</a></li>
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="pages-starter.html">资源查询</a></li>
                                    <li><a href="pages-maintenance.html">批量导入</a></li>
                                    <li><a href="pages-comingsoon.html">新增替换</a></li>
                                    <li><a href="pages-timeline.html">替换列表</a></li>
                                </ul>
                            </li>
                    ...
                    <!-- Sidebar  uim uim-repeat 系统更新 uim uim-arrow-circle-down  系统商店 uim uim-briefcase 退出登录 uim uim-exit -->
                </div>
            </div>
    <!-- END Sidebar -->
        <style>
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">资源搜索</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">资源管理</a></li>
                                    <li class="breadcrumb-item active">资源搜索</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">资源搜索</h4>
                                            <p class="card-title-desc">此功能仅仅适用于快速获取链接,暂不支持电视剧！ <code>仅支持电影</code>.
