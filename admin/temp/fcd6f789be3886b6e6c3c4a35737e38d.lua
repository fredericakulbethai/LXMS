<?php /*a:4:{s:64:"/www/wwwroot/jifei.ymcx.shop/view/admin/globalsite/api_site.html";i:1603849870;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">API设置</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">全局设置</a></li>
                                    <li class="breadcrumb-item active">API设置</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">API信息配置</h4>
                                            <p class="card-title-desc">API需要是 <code>json格式</code> json格式在app中的home模块中的api控制器  <code>不会切勿改动！</code> 后台接口是用户后台测试接口 并不是json切勿弄混！</p>
    
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">影视API</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($api); ?>" name="api">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">短视频API</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($dspapi); ?>" name="dspapi">
                                                </div> 
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-email-input" class="col-md-2 col-form-label">后台接口</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($htjx); ?>" name="htjx">
                                                </div>
                                            </div>
        ...
        <script>
            $(document).ready(function(){
                $("#submit").click(function(){
                        ...
                        var dspapi = $("input[name='dspapi']").val();
                        var htjx   = $("input[name='htjx']").val();
                        $.ajax({
                          url:'/admin/globalsite/apiSettings',
                          type:'post',
                          data:{
                              api:api,
                              dspapi:dspapi,
