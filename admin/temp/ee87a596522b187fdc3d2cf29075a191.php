<?php /*a:6:{s:58:"/www/wwwroot/jifei.ymcx.shop/view/admin/website/index.html";i:1603508437;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/inc.html";i:1603029668;s:50:"/www/wwwroot/jifei.ymcx.shop/view/admin/aside.html";i:1603291306;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1603369242;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1602426806;s:47:"/www/wwwroot/jifei.ymcx.shop/view/admin/js.html";i:1603508344;}*/ ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
            ...
            <main id="main-container">
                <!-- Hero -->
                <div class="bg-image overflow-hidden" style="background-image: url('/static/adassets/media/photos/photo3@2x.jpg');">
                    <div class="bg-primary-dark-op">
                        <div class="content content-narrow content-full">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center mt-5 mb-2 text-center text-sm-left">
                                <div class="flex-sm-fill">
                                    <h1 class="font-w600 text-white mb-0 invisible" data-toggle="appear">仪表盘</h1>
                                ...
                                <div class="flex-sm-00-auto mt-3 mt-sm-0 ml-sm-3">
                                    <span class="d-inline-block invisible" data-toggle="appear" data-timeout="350">
                                        <a class="btn btn-primary px-4 py-2" data-toggle="click-ripple" href="javascript:void(0)">
                                            <i class="fa fa-plus mr-1"></i> 添加站点
                                        </a>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                            <a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">全站调用</div>
                                    <div class="font-size-h2 font-w400 text-dark">12331次</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                            <a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">全站用户</div>
                                    <div class="font-size-h2 font-w400 text-dark">150名</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                            <a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">全站收入</div>
                                    <div class="font-size-h2 font-w400 text-dark">3,200元</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                            <a class="block block-rounded block-link-pop border-left border-primary border-4x" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">替换资源</div>
                                    <div class="font-size-h2 font-w400 text-dark">21个</div>
                                </div>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                        <thead>
                                            <tr class="text-uppercase">
                                                <th class="font-w700" style="width: 80px;">UID</th>
                                                <th class="d-none d-sm-table-cell font-w700 text-center" style="width: 100px;">头像</th>
                                                <th class="font-w700">账号</th>
                                                <th class="d-none d-sm-table-cell font-w700 text-center" style="width: 80px;">调用</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar12.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Ralph Murray                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar7.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Susan Day                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar1.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Lisa Jenkins                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar14.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Jeffrey Shaw                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar4.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Melissa Rice                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell text-center">
                                                    <img class="img-avatar img-avatar32" src="/static/adassets/media/avatars/avatar15.jpg" alt="">
                                                </td>
                                                <td class="font-w600">
                                                    Jack Greene                                </td>
                                                <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                        <thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="d-none d-sm-table-cell font-w700 text-center" style="width: 100px;">头像</th>
                                                <th class="font-w700">账号</th>
                                                <th class="d-none d-sm-table-cell font-w700 text-center" style="width: 80px;">时间</th>
                                                <th class="font-w700 text-center" style="width: 60px;"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
