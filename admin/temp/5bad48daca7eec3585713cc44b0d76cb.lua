<?php /*a:4:{s:58:"/www/wwwroot/jifei.ymcx.shop/view/admin/set_meal/edit.html";i:1605597097;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1604888981;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value='<?php echo htmlentities($meal['name']); ?>' name="name" placeholder="例如 包月套餐">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">价格</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" value='<?php echo htmlentities($meal['price']); ?>' name="price">
                                                </div> 
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="custom-select" id="dian" name="type">
                                                        <option value="1" <?php if($meal['type'] == '1'): ?>selected<?php endif; ?>>包点套餐</option>
                                                        <option value="2"<?php if($meal['type'] == '2'): ?>selected<?php endif; ?>>包月套餐</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row" id="k">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="number" value='<?php echo htmlentities($meal['fs']); ?>'  name="fs" placeholder="套餐包含几月就填几 点数可自由设置">
                                                </div>
                                            </div>
                                            <div class="form-group row" id="limit">
                                            <?php if($meal['type']==2): ?>
                                                <label for="example-url-input" class="col-md-2 col-form-label" id="textmonth">限制</label><div class="col-md-10"><input class="form-control" type="number"  name="limtsecond" value="<?php echo htmlentities($meal['limtsecond']); ?>" placeholder="限制每日调用次数 例如10000"></div>
                                            <?php endif; ?>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-md-2 col-form-label">套餐介绍</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="introduce" rows="10"><?php echo $meal['introduce']; ?></textarea>
                                                </div>
                                            </div>
                                            <input type="hidden" name="id" value="<?php echo htmlentities($meal['id']); ?>">
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">是否启用</label>
                                                <div class="col-md-10">
                                                    <select class="custom-select" name="status">
                                                        <option value="1"<?php if($meal['status'] == '1'): ?>selected<?php endif; ?>>启用</option>
                                                        <option value="2"<?php if($meal['status'] == '2'): ?>selected<?php endif; ?>>关闭</option>
                                                    </select>
                                                </div>
                                            </div>
