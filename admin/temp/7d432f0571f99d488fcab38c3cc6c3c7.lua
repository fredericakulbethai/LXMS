<?php /*a:4:{s:65:"/www/wwwroot/jifei.ymcx.shop/view/admin/user_manage/increase.html";i:1604734602;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">账户加款</h4>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text"  name="name" value="<?php echo input('get.user'); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
