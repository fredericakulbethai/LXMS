<?php /*a:4:{s:59:"/www/wwwroot/zc.appearoo.top/view/admin/set_meal/index.html";i:1604714505;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1615047338;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">套餐列表</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">套餐管理</a></li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if($data['type'] == '1'): ?>包点<?php endif; if($data['type'] == '2'): ?>包月<?php endif; ?></td>
                                                    <td><?php echo htmlentities($data['price']); ?></td>
                                                    <td><?php if($data['type'] == '1'): ?><?php echo htmlentities($data['fs']); ?>点数<?php endif; if($data['type'] == '2'): ?><?php echo htmlentities($data['fs']); ?>月<?php endif; ?></td>
                                                    ...
                                                    <td><a href="<?php echo url('edit'); ?>?id=<?php echo htmlentities($data['id']); ?>">编辑</a> <a href="<?php echo url('/admin/SetMeal/deletejk'); ?>?id=<?php echo htmlentities($data['id']); ?>">删除</a></td>
                                                </tr>
