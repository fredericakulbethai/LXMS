<?php /*a:4:{s:69:"/www/wwwroot/jifei.ymcx.shop/view/admin/globalsite/register_site.html";i:1604645164;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">SMTP用户名是你的邮箱账号<code>例如 1178350505@qq.com</code> smtp密码自行百度搜索, 注册赠送是用户注册账号后赠送的点数</p>
    
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">SMTP用户名</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($emailname); ?>" name="emailname">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">SMTP密码</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($authcode); ?>" name="authcode">
                                                </div> 
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">注册赠送</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($give); ?>" name="give">
                                                </div> 
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">邮箱注册</label>
                                                <div class="col-md-10">
                                                    <select class="custom-select" name="email">
                                                        <option value="1" <?php if($email == '1'): ?>selected<?php endif; ?>>启用</option>
                                                        <option value="0"<?php if($email == '0'): ?>selected<?php endif; ?>>关闭</option>
                                                    </select>
                                                </div>
                                            </div>
