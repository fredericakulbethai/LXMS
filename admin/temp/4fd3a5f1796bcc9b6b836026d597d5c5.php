<?php /*a:4:{s:65:"/www/wwwroot/jifei.ymcx.shop/view/admin/site_manage/addadmin.html";i:1604734659;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604041642;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1604110017;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!--<!doctype html>-->
<!--<html lang="en">-->
<!--   <head>
        <meta charset="utf-8" />
...
<!--                                    <li class="breadcrumb-item active">账户加款</li>-->
<!--                                    </ol>-->
<!--                                </div>-->
...
<!--                                            <h4 class="header-title">账户加款</h4>-->
<!--                                            <p class="card-title-desc">可以是负数 <code>负数是扣款</code></p>-->
...
<!--                                            </div>-->
<!--                                            <div class="form-group row">-->
<!--                                                <label for="example-search-input" class="col-md-2 col-form-label">金额</label>-->
<!--                                                <div class="col-md-10">-->
...
<!--                        $("#submit").html('<span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>加载中...');-->
