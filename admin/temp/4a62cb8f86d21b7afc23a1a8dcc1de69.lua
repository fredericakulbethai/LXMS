<?php /*a:4:{s:70:"/www/wwwroot/zc.appearoo.top/view/admin/resour_manage/new_replace.html";i:1604318824;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">新增替换</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">资源管理</a></li>
                                    <li class="breadcrumb-item active">新增替换</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="" name="newurl">
                                                </div> 
                                            </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#submit").click(function(){
                        ...
                        $.ajax({
                          url:'/admin/ResourManage/newReplace',
                          type:'post',
                          data:{
                              name:name,
                              url:url,
