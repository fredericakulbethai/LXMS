<?php /*a:4:{s:64:"/www/wwwroot/jifei.ymcx.shop/view/admin/globalsite/web_site.html";i:1604644433;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
   <head>
        <meta charset="utf-8" />
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">网站设置</h4>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">网站信息配置</h4>
                                            <p class="card-title-desc">修改完信息 <code>注意保存</code> 如有不生效请清理缓存</p>
    
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">网站标题</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($webtitle); ?>" name="name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">网站关键词</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($keyword); ?>" name="keyword">
                                                </div> 
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-email-input" class="col-md-2 col-form-label">网站描述</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($contents); ?>" name="contents">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-url-input" class="col-md-2 col-form-label">QQ链接</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="url" value="<?php echo htmlentities($qq); ?>" name="qq">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-tel-input" class="col-md-2 col-form-label">QQ群链接</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($qun); ?>" name="qun">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-number-input" class="col-md-2 col-form-label">客户端URL</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($khdurl); ?>" name="khdurl">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">主题模板</label>
                                                <div class="col-md-10">
                                                    <select class="custom-select" name="tep">
                                                        <?php echo $moban; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-md-2 col-form-label">网站公告</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="notice" rows="10"><?php echo htmlentities($notice); ?></textarea>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-md-2 col-form-label">轮播广告</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="lbtgg" rows="10"><?php echo htmlentities($lbtgg); ?></textarea>
                                                </div>
                                            </div>
        ...
        <script>
            $(document).ready(function(){
                $("#submit").click(function(){
                        ...
                        var qun     = $("input[name='qun']").val();
                        var tep     = $("select[name='tep']").val();
                        var khdurl  = $("input[name='khdurl']").val();
                        var lbtgg   = $("textarea[name='lbtgg']").val();
                        var notice  = $("textarea[name='notice']").val();
                        $.ajax({
                           url:'/admin/globalsite/configSettings',
                           type:'post',
                           data:{
                               name:name,
                               keyword:keyword,
