<?php /*a:4:{s:59:"/www/wwwroot/jifei.ymcx.shop/view/admin/update/upgrade.html";i:1605773463;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
...
<div class="main-content">
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">系统更新</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div>
                                                        ...
                                                        <h3>云海计费系统 <span class="badge badge-primary ml-1">正式版</span> <span class="badge badge-soft-primary">v<?php echo htmlentities($edition); ?></span></h3>

                                                        <div class="mt-4 mt-xl-5" id="buttons">
                                                            <h5 class="font-size-16 mb-3" id="content"><center>请先检测更新</center></h5>
                                                            
                                                            <button type="button" class="btn btn-info mr-2" id="buts">
                                                                检测更新 
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="mt-4 mt-xl-0">
                                                        <h5 class="font-size-16 mb-3">系统公告</h5>
        ...
        $(document).ready(function(){
                    $("#buts").click(function(){
                         ed = '';
                         $("#buts").html('<span class="spinner-border spinner-border-sm mr-1" role="status" aria-hidden="true"></span>加载中...');
                         $.ajax({
                             url:'./getedition',
                             type:'post',
                             data:{},
                             success:function(data){
                                 ...
                                 if(data.type==1){
                                     ...
                                     $("#buts").remove();
                                      $("#b").remove('');
                                     $("#buttons").append('<button type="button" class="btn btn-info mr-2" id="b">一键更新</button>');
                                 }
                             }
