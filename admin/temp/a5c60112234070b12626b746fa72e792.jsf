<?php /*a:4:{s:63:"/www/wwwroot/jifei.ymcx.shop/view/admin/resour_manage/edit.html";i:1604719000;s:49:"/www/wwwroot/jifei.ymcx.shop/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/jifei.ymcx.shop/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/jifei.ymcx.shop/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">修改替换</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">资源管理</a></li>
                                    <li class="breadcrumb-item active">修改替换</li>
                                    </ol>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">修改替换</h4>
                                            <p class="card-title-desc">此功能不懂请上官网博客查看,替换前请查看播放器是否支持播放!看看链接是否正常<code>本系统优先走替换！</code> </p>
    
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">名称</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($replace['name']); ?>" name="name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">原链接</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($replace['url']); ?>" name="url">
                                                </div> 
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">新链接</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="<?php echo htmlentities($replace['newurl']); ?>" name="newurl">
                                                </div> 
                                            </div>
                                            <input type="hidden" name="id" value="<?php echo htmlentities($replace['id']); ?>">
                                             <div class="form-group row">
                                                <label class="col-md-2 col-form-label">是否启用</label>
                                                <div class="col-md-10">
                                                    <select class="custom-select" name="status">
                                                        <option value="1" <?php if($replace['status'] == '1'): ?>selected<?php endif; ?>>启用</option>
                                                        <option value="2"<?php if($replace['status'] == '2'): ?>selected<?php endif; ?> >关闭</option>
                                                    </select>
                                                </div>
                                            </div>
