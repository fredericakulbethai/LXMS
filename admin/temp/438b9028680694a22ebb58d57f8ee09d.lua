<?php /*a:4:{s:57:"/www/wwwroot/zc.appearoo.top/view/admin/index/index2.html";i:1604284266;s:49:"/www/wwwroot/zc.appearoo.top/view/admin/head.html";i:1604892943;s:48:"/www/wwwroot/zc.appearoo.top/view/admin/nav.html";i:1606714786;s:51:"/www/wwwroot/zc.appearoo.top/view/admin/footer.html";i:1604233180;}*/ ?>
<!doctype html>
<html lang="en">
       <head>
        <meta charset="utf-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="header-title">站点信息</h5>
                                            <p>当前版本: <small>yunhai 4.0</small></p>
                                            <p>授权域名: <small><?php echo htmlentities($jifei[1]); ?></small></p>
                                            <p>授权QQ: <small><?php echo htmlentities($jifei[0]); ?></small></p>
                                            <p>授权状态: <small><?php if($jifei[3] == '1'): ?>正常<?php endif; if($jifei[3] == '2'): ?>封禁<?php endif; ?></small></p>
                                            <p>官网博客: <small><a href="http://cloudhai.cn" target="_blank">cloudhai.cn</a></small></p>
                                            <p>唯一QQ: <small><a href="http://wpa.qq.com/msgrd?v=3&uin=1178350505&site=qq&menu=yes" target="_blank">1178350505</a></small></p>
                                            <p>售后群: <small>475573854</small></p>
                                            <p>系统token: <small><?php echo session('jifei'); ?></small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
