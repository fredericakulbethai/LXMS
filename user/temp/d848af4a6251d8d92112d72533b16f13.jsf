                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-title font-14">数据仅供参考，此记录只会保存一天！请熟知！</p>
                                        ...
                                        <div class="table-rep-plugin">
                                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                                <table id="tech-companies-1" class="table  table-striped">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <th><?php echo htmlentities($record['id']); ?></th>
                                                        <td><?php echo htmlentities($record['url']); ?></td>
                                                        <td><?php echo htmlentities($record['ip']); ?></td>
                                                        <td><?php echo htmlentities($record['uid']); ?></td>
                                                        <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($record['intime'])? strtotime($record['intime']) : $record['intime'])); ?></td>
                                                        <td>
                                                        <?php if($candition=$record['status']==1): ?>
                                         ...
                                         <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="?page=<?php echo htmlentities($page-1); ?>"><?php echo htmlentities($page-1); ?></a></li>
                                                <li class="page-item active">
                                                    <a class="page-link" href="#"><?php echo htmlentities($page); ?><span class="sr-only">(current)</span></a>
                                                </li>
                                                <li class="page-item"><a class="page-link" href="?page=<?php echo htmlentities($page+1); ?>"><?php echo htmlentities($page+1); ?></a></li>
                                                <li class="page-item">
                                                    <a class="page-link" href="?page=<?php echo htmlentities($page+1); ?>">Next</a>
                                                </li>
                                        </ul>
