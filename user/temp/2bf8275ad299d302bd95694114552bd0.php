        ...
        <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                 <iframe class="video" src="<?php echo htmlentities($htjx); ?>" style="width:100%;height: 400px" frameborder="0" scrolling="no"></iframe>
                                <!-- <div class="card m-b-30">
                                    <div class="card-body" style="width: 100%">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="<?php echo htmlentities($htjx); ?>"></iframe>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                            <div class="col-xl-6">
                                 <div class="card m-b-30">
                                     <div class="card-body">
                                        <form action="/user/video" method="post">
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">视频链接</label>
                                        <input name="url" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="https://www.iqiyi.com/v_24h60bowzyk.html">
                                        <small id="emailHelp" class="form-text text-muted">填写视频链接即可播放</small>
                                        </div>
