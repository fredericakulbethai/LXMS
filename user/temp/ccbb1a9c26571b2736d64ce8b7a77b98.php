                    ...
                    <div class="col-lg-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <form class="" action="/user/pay/pay" method="post">
                                            <div class="form-group">
                                                <label>订单号</label>
                                                <input name="ordernum" type="text" class="form-control" value="<?php echo date('Ymdhis'); ?>"readonly="readonly" />
                                            </div>
        
                                            <div class="form-group">
                                                <label>充值金额</label>
                                                <div>
                                                    <input name="price" type="number" class="form-control" value="10" />
                                                </div>
                                            </div>
