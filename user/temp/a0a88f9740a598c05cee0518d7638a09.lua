            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="text-center">
                                <h5>自助购买</h5>
                                <p class="text-muted"><font color="red">温馨提示：如果当前是包点购买包月后会将点数清零 同样当前是包月购买包点套餐将会把天数清空</font></p>
                                 <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <a href="/user/price?types=1"><label class="btn btn-info">
                                                    <font color="white">包点套餐</font>
                                                </label></a>
                                                <a href="/user/price?types=2"><label class="btn btn-info">
                                                    <font color="white">包月套餐</font>
                                                </label></a>
                        </div>
                            </div>
                    ...
                    <div class="row m-t-30">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tc): $mod = ($i % 2 );++$i;?>
                        <div class="col-xl-3 col-md-6">
                            <div class="card pricing-box mt-4">
                                ...
                                <div class="pricing-content">
                                    <div class="text-center">
                                        <h5 class="text-uppercase mt-5"><?php echo htmlentities($tc['name']); ?></h5>
                                        <div class="pricing-plan mt-4 pt-2">
                                            <h1><?php echo htmlentities($tc['price']); ?> ¥</h1>
                                        </div>
                                        <div class="pricing-border mt-5"></div>
                                    </div>
                                    <div class="pricing-features mt-4">
                                            <?php echo $tc['introduce']; ?>
                                    </div>
                                    <div class="pricing-border mt-4"></div>
                                    <div class="mt-4 pt-3 text-center">
                                        <a href="/user/price/purChase?id=<?php echo htmlentities($tc['id']); ?>" class="btn btn-success btn-lg w-100 btn-round">购买</a>
                                    </div>
                                </div>
                            </div>
                        </div>
