<?php /*a:5:{s:61:"/www/wwwroot/zc.appearoo.top/view/user/information/index.html";i:1601811802;s:48:"/www/wwwroot/zc.appearoo.top/view/user/head.html";i:1601905500;s:47:"/www/wwwroot/zc.appearoo.top/view/user/msg.html";i:1601710952;s:47:"/www/wwwroot/zc.appearoo.top/view/user/nav.html";i:1602052598;s:48:"/www/wwwroot/zc.appearoo.top/view/user/foot.html";i:1601657034;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
                            ...
                            <div class="col-lg-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">账户设置</h4>
                                        <p class="sub-title">信息修改完成记得点击保存,否则修改不生效</p>
        
                                        <form class="" action="/user/information/upData" method="post">
                                            <div class="form-group">
                                                <label>用户名</label>
                                                <input type="text" class="form-control" value="<?php echo htmlentities($username); ?>" disabled ="disabled" />
                                            </div>
        
                                            <div class="form-group">
                                                <label>绑定邮箱</label>
                                                <div>
                                                    <input type="email" class="form-control" value="<?php echo htmlentities($email); ?>" disabled ="disabled" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>绑定QQ</label>
                                                <div>
                                                    <input name="qq" data-parsley-type="number" type="text"
                                                           class="form-control" value="<?php echo htmlentities($qq); ?>" />
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">账户信息</h4>
                                        <p class="sub-title">请自行保存好秘钥,切勿泄露此秘钥,建议定期更换新的秘钥</p>
                                    <form method="post" action="/user/information/replaceKey">
                                    <div class="form-group">
                                                <label>UID</label>
                                                <input type="number" class="form-control" value="<?php echo htmlentities($user_uid); ?>" disabled ="disabled" />
                                    </div>
                                    <div class="form-group">
                                                <label>KEY</label>
                                                <input type="text" class="form-control" value="<?php echo htmlentities($user_key); ?>" disabled ="disabled" />
                                    </div>
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                        更换秘钥
                                                    </button>
