                                ...
                                <div class="col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">示例</h4>
                                            <p class="sub-title">适用于小程序或app调用！</p>

                                                        <div class="">
                                                                <h6><span class="badge badge-primary">抖音</span> <a href="<?php echo htmlentities($jxtext); ?>"><?php echo htmlentities($jxtext); ?></a></h6>
                                                              
                                                                <h6><span class="badge badge-primary">支持</span> 抖音、火山、头条、快手、梨视频、美拍、陌陌、皮皮搞笑、皮皮虾、全民搞笑、刷宝、微视、小咖秀、最右 等主流短视频</h6>

                                                                <h6><span class="badge badge-primary">请求方式:</span> GET 解析一次扣除一点，不成功不收费！部分平台视频本身带有水印，无法去掉视频本身的水印，请详知！</h6>

                                                                <h6><span class="badge badge-primary">参数说明:</span> CODE = 200 即解析成功  USER 代表视频的作者的账号   CONTENT 代表视频的介绍内容  IMG 代表视频封面图片的链接  URL 代表短视频的真实地址【部分平台水印】</h6>
                                                            </div>
