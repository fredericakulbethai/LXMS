                                ...
                                <div class="col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">客户端示例</h4>
                                            <p class="sub-title">适用于主流cms内容管理系统！</p>

                                                        <div class="">
                                                                <h6><span class="badge badge-primary">第一步</span>  <a href="<?php echo htmlentities($khd); ?>">下载客户端</a></h6>

                                                              	<h6><span class="badge badge-primary">第二步</span> 在宝塔创建新站点,并解压本安装包</h6>

                                                              	<h6><span class="badge badge-primary">第三步</span>  复制 uid:<?php echo htmlentities($useruid); ?> key:<?php echo htmlentities($userkey); ?> </h6>

                                                              	<h6><span class="badge badge-primary">第四步</span> 将以上信息在user.php中修改</h6>
                                                                
                                                                <h6><span class="badge badge-primary">完成</span> 自行测试是否正常播放,有问题请点击左侧常见问题</h6>
                                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">json示例</h4>
                                            <p class="sub-title">适用于各种需要json格式的程序调用</p>

                                                        <div class="">
                                                                <h6><span class="badge badge-primary">示例</span> <a href="<?php echo htmlentities($jxtext); ?>"><?php echo htmlentities($jxtext); ?></a></h6>
                                                              <h6>保管好自己的秘钥</h6>
